...
var _ = Describe("Query Builder", func() {
	...
	Context("Build", func() {
		It("creates a successful query", func() {
			b := query.NewBuilder().Stream(query.S[int]("builder1", true, false)).Query(query.ContinuousBatchSum[int]("builder1", "builder2", selection.NewCountingWindowPolicy[int](10, 10)))
			q, ok := b.Build()
